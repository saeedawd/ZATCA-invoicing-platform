...
<head>
    ...
    <style>
        ...
        .header .sub { color: #ffffffcc; font-size: 10px; margin-top: 3px; }
        .gold-line {
            height: 3px;
        ...
        .items tbody tr:nth-child(even) td { background: #f7fbf9; }
...
<body>
    ...
    <div class="gap"></div>
    @include('pdf.templates.partials.totals', ['borderColor' => '#d7e4dd'])
    <div class="gap"></div>
